...
import com.daimajia.swipedemo.adapter.CommListViewAdapter;
import com.daimajia.swipedemo.adapter.ListViewAdapter;

import java.util.Arrays;
import java.util.List;

public class CommListViewActivity extends Activity {

    private ListView mListView;
    private CommListViewAdapter mAdapter;
...
//        mListView.setAdapter(new ArraySwipeAdapterSample<String>(this, R.layout.listview_item, R.id.position, adapterData));
        ...
        mAdapter = new CommListViewAdapter();
